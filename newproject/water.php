...
<option value="Pits on roads">Drinking water</option>
<option value="RTC services">Bore water</option>
<option value="Traffic Congestion">Drainage </option>
<option value="Metro service">leakage of pipes </option>
<option value="transformers">Other</option>
</select></div><br/>
  <div >
