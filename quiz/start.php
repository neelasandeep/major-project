...
<tr><td><b>TEST NAME &nbsp&nbsp&nbsp </b></td>
...
$subject=$_POST['subject'];
  ...
  $section=$_POST['sec'];	
	...
	$query="UPDATE `testdetails` SET `STATUS`='true' WHERE USER_ID='$username' AND BRANCH='$branch' AND SUBJECT='$subject' AND SECTION='$section' AND TEST_NAME='$tname'";
	$que=mysqli_query($db,$query);
	echo $exam."started sucessfully";
	$query="UPDATE `students_login` SET `STATUS`='true' WHERE BRANCH='$branch' AND YEAR='$year' AND SEMISTER='$semister' AND SECTION='$section'";
	$que=mysqli_query($db,$query);
	$query="UPDATE `testdetails` SET `COMPLETED`='true' WHERE USER_ID='$username' AND BRANCH='$branch' AND SUBJECT='$subject' AND SECTION='$section' AND TEST_NAME='$tname'";
	$que=mysqli_query($db,$query);
	} 
