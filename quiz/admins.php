...
<html>
<head>
	<title>student registrstion</title>
	...
	<header>
    		<nav>
    			...
    			<ul id="nav">
    				...
    				<li><a class="homeblack" href="studentlogin.php">Student</a></li>
    				<li><a class="homeblack" href="admins.php">Admin</a></li>
...
&nbsp &nbsp &nbsp <input type="submit" name="bt1" value="submit">
</form>
