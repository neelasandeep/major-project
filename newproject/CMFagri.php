...
$que="SELECT PINCODE,count(*) as number FROM problems where DATEDIFF('$dat',TIME)>1 and CATEGERY='$categery' GROUP BY PINCODE";
...
date_default_timezone_set('Asia/Kolkata');
$dat=date('Y-m-d H:i:s');
$sa="SELECT PROBLEM,PROBLEM_DESC FROM problems where DATEDIFF('$dat',TIME)>0 and PINCODE='$pin' and CATEGERY='$categery'";
